...
public class GuiGraphics implements ricm3.gpi.gui.Graphics {

  java.awt.Graphics g;
  ricm3.gpi.gui.Color color;
  GuiFont font;

  GuiGraphics(java.awt.Graphics g) {
    this.g = g;
    FontMetrics fm = g.getFontMetrics();
    this.font = new GuiFont(fm.getFont());
    java.awt.Color c = g.getColor();
    int rgb = c.getRGB();
    int alpha = c.getAlpha();
    this.color = new ricm3.gpi.gui.Color(rgb, alpha);
  }
  ...
  public Graphics create(int x, int y, int width, int height) {
    return new GuiGraphics(g.create(x, y, width, height));
  }
